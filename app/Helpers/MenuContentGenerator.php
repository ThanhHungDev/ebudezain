...
* 
* @author Denys Hrechanyi <dhrechanyi@gmail.com>
*/
class MenuContentGenerator {
	public static function generate(string $text) {
		$table_content = self::buildMenuTree(self::parseHeadings($text));
		$text = self::addHeadingsIdentifiers($text, $table_content);
		return (object)compact('table_content', 'text');
	}

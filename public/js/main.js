...
$(document).ready(function() {
    ...
    $(window).on('load resize', function() {
        $(".wrapper-item-post").each(function() {
            formatHeight($(this).get(0), 'topic-post-block')
        });
...
function formatHeight(parent, classElement) {
    var elementsFormat = parent.getElementsByClassName(classElement);
    resetHeightIndexOf(elementsFormat);
    var iteminRow = 1;
    ...
    for (let index = 0; index < elementsFormat.length; index += iteminRow) {
        ...
        fixHeightIndexOf(elementsFormat, maxHeight, begin, end);
    }
}
...
function fixHeightIndexOf(elements, height, begin, end) {
    var classFixHeight = 'js-item-format-height';

    for (var index = begin; index <= end; index++) {

        elements[index].getElementsByClassName(classFixHeight)[0].style.height = height + "px";
    }
}

function resetHeightIndexOf(elements) {
    var classFixHeight = 'js-item-format-height';

...
<head>
    ...
    {% include "genneral/css/admin/admin.twig" %}
    {% include "genneral/css/animate.twig" %}
    {% include "genneral/css/main.twig" %}
    {% include "genneral/css/progress.twig" %}
    {% include "genneral/css/alert.twig" %}
    {% endblock %}
</head>
<body>
    <div class="wrapper-page">
        <div class="wrapper-header-page">
            {% include 'layout/admin/partial/header.twig' %}
        </div>
        <div class="wrapper-main-page">
            {% block main %}{% endblock %}
        </div>
        <div class="wrapper-footer-page">
            {% include 'layout/admin/partial/footer.twig' %}
        </div>
    </div>
